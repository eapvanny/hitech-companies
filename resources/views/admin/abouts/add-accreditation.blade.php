...
<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.18/summernote.min.js"></script> --}}
    <title>{{__('Post a new accreditation')}} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Post a new accreditation')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('Post a new accreditation')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container px-2" style="min-height: auto">
                        <form action="{{ route('accreditation.save') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row align-items-center">
                                ...
                                <div class="ui input">
                                    <input type="text" name="name_kh" id="name_kh" placeholder="Name in Khmer"  value="{{ old('name_kh') }}">
                                </div>

                                <h3 class="card-title my-3">Name in English</h3>
                                <div class="ui input">
                                    <input type="text" name="name_en" id="name_en" placeholder="Name in English" value="{{ old('name_en') }}">
                                </div>
