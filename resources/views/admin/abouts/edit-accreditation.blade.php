...
<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.18/summernote.min.js"></script> --}}
    <title>{{__('Edit accreditation')}} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Edit/Update accreditation')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('Edit/Update accreditation')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container px-2" style="min-height: auto">
                        <form action="{{ route('accreditation.doEdit', ['id' => $accreditation->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row align-items-center">
                                {{-- <div class="col-sm-12 col-md-7 col-lg-7 col-xl-7"> --}}
                                <h4 class="card-title mb-3">Upload image for accreditation</h4>

                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="img" class="text-center p-2 label-image">
                                                <img src="{{ asset($accreditation->logo) }}" id="pre_img" alt="" class="m-auto">
                                                <div class="hover-bg">
                                    ...
                                    <input type="file" id="img" name="logo" style="cursor: pointer; display:none;" class="" accept="image/*">
                                    <input type="hidden" id="img" name="old_logo" style="cursor: pointer; display:none;" class="" value="{{ $accreditation->logo }}">

                                {{-- <input type="hidden" value="{{ $about->img }}" name="old_thumbnail"> --}}
                                
                                <h3 class="card-title my-3">Name in Khmer</h3>
                                <div class="ui input">
                                    <input type="text" name="name_kh" id="name_kh" placeholder="Name in Khmer"  value="{{ $accreditation->name_kh }}">
                                </div>

                                <h3 class="card-title my-3">Name in English</h3>
                                <div class="ui input">
                                    <input type="text" name="name_en" id="name_en" placeholder="Name in English" value="{{ $accreditation->name_en }}">
                                </div>
                            ...
                            <div class="ui toggle checkbox px-0 mt-2">
                                <input type="checkbox" value="1" id="check" name="active_status" {{ ($accreditation->active_status == 1 ? 'checked' : '') }}>
