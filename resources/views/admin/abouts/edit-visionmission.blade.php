...
<script src="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.18/summernote.min.js"></script> --}}
    <title>{{ __('Edit Vision and Mission') }} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{ __('Edit/Update Vision and Mission') }}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('Edit/Update Vision and Mission')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container px-2" style="min-height: auto">
                        <form action="{{ route('visionmission.doEdit') }}" method="post">
                            @csrf
                            <div class="row align-items-center">
                                <h3 class="card-title my-3">Text in Khmer</h3>
                                <textarea name="text_kh" id="text_kh">{!! $about->text_kh !!}</textarea>

                                <h3 class="card-title my-3">Text in English</h3>   
                                <textarea name="text_en" id="text_en">{!! $about->text_en !!}</textarea>
                            </div>
