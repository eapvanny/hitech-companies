...
@section('title')
    <title>{{ __('Edit post ads') }} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Edit/Update post ads')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('Edit/Update post ads')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container" style="min-height: auto">
                        <form method="post" action="{{ route('ads.doEdit', ['id'=>$data->id]) }}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="container">
                                <div class="row p-4">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="ui placeholder segment" style="display: flex; flex-direction: row; gap: 20px; align-items: center;">
                                                    @php
                                                        ...
                                                        // Pad the array to ensure 2 elements, filling with empty strings if needed
