...
@section('title')
    <title>{{ __('Post blog') }} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Add new post blog')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('New post blog')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container" style="min-height: auto">
                        <form method="post" action="{{ route('blog.save') }}" autocomplete="off" enctype="multipart/form-data">
                            <div class="container">
                                <div class="row p-4">
                                    <div class="col-sm12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="ui input w-100">
                                            ...
                                            <input type="text" placeholder="Enter author's name" id="author" name="author" value="{{ old('author') }}">
                                        ...
                                        <div class="ui form">
                                            <div class="field">
                                                ...
                                                <textarea rows="4"  placeholder="Short description in Khmer" name="short_text_kh">{{ old('short_text_kh') }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="ui form">
                                            <div class="field">
                                                ...
                                                <textarea rows="4" id="description_kh" placeholder="Description in Khmer" name="description_kh">{{ old('description_kh') }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="ui form">
                                            <div class="field">
                                                ...
                                                <textarea rows="4"  placeholder="Short description in English" name="short_text">{{ old('short_text') }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="ui form">
                                            <div class="field">
                                                ...
                                                <textarea rows="4" id="description" placeholder="Description in English" name="description">{{ old('description') }}</textarea>
                                            </div>
                                        </div>
