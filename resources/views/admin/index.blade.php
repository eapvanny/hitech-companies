...
<script src="{{ asset('backends/assets/js/calendar/calendar.global.min.js') }}"></script>
<script>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title"><i class="fas fa-calendar-alt"></i> Calendar</div>
