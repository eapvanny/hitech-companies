...
@section('title')
    <title>{{ __('Post society') }} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Add new post society')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('New post society')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container" style="min-height: auto">
                        <form method="post" action="{{ route('society.add') }}" autocomplete="off" enctype="multipart/form-data">
                            <div class="container">
                                <div class="row p-4">
                                    <div class="col-sm12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="ui input w-100">
                                            ...
                                            <input type="text" placeholder="Enter title" id="title" name="title_kh" value="{{ old('title_kh') }}">
                            ...
                            <div class="modal-footer">
                                <a href="{{ route('home.society') }}" class="btn btn-label-warning btn-round btn-md hover-btn me-2">Back</a>
