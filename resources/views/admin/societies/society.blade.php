...
@section('title')
    <title>{{__('Society')}} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Society')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('Society post lists')}}</div>
                        ...
                        <a class="btn btn-label-info btn-round btn-sm hover-btn" id="update-btn" data-content="Post new society"
                            href="{{ route('society.post') }}">
                            <span class="btn-label">
                                ...
                                @foreach ($datas as $social)
                                        ...
                                        <td class="right aligned top w-10">
                                            <div class="circular ui icon button ui icon top left right bottom pointing dropdown">
                                                ...
                                                <div class="menu" id="menu{{ $social->id }}">
                                                    ...
                                                    @endif
                                                    <a href="{{ route('society.edit', ['id'=>$social->id]) }}" class="text-black item">Edit/Update</a>
                                    ...
                                    <div class="modal fade modal-sm" id="deleteModel{{$social->id}}"  tabindex="-1" aria-labelledby="deleteModel{{$social->id}}Label" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form action="{{ route('society.delete', ['id'=> $social->id]) }}" method="POST">
                                    ...
                                    <div class="modal fade modal-sm" id="activeStatus{{$social->id}}"  tabindex="-1" aria-labelledby="activeStatus{{$social->id}}Label" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            ...
                                            <form action="{{ route('society.status', ['id'=> $social->id]) }}" method="POST">
                                                <div class="modal-body text-center">
                                                        @csrf
