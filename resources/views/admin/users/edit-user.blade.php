...
@section('title')
    <title>{{ __('Edit user') }} | Hi-Tech</title>
@endsection
...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
        <h3 class="fw-bold mb-3">{{__('Edit/Update user')}}</h3>
            ...
            <div class="card card-round">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">{{__('Edit/Update user')}}</div>
                ...
                <div class="card-body">
                    <div class="chart-container" style="min-height: auto">
                        <form method="post" class="ui form" action="{{ route('user.doEdit', ['id'=> $user->id]) }}" autocomplete="off" id="addUserForm">
                            <div class="container">
                                <div class="row px-4">
                                    <div class="col-sm12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="ui field left icon input w-100 d-block">
                                            ...
                                            <input type="text" class="w-100" placeholder="Enter fullname" id="name" name="name" value="{{ $user->name }}">
                                        ...
                                        <div class="ui field left icon input w-100">
                                            <i class="user icon"></i>
                                            <input type="text" placeholder="Enter username" id="username" name="email" value="{{ $user->email }}">
                                        ...
                                        <div class="wide field">
                                            <div class="field w-100">
                                                <select class="ui fluid search dropdown w-100" name="role">
                                                    <option value="admin" {{ $user->role == 'admin' ? 'selected' : '' }}><i class="fas fa-user pe-1" style="color: #ed9911;"></i> Admin</option>
                                                    <option value="superadmin" {{ $user->role == 'superadmin' ? 'selected' : '' }}><i class="fas fa-user-shield pe-1" style="color: #1061b3;"></i> Super admin</option>
                                                </select>
                                            </div>  
                                        </div>
                                        ...
                                        <div class="ui toggle checkbox px-0 mt-2">
                                            <input type="checkbox" value="1" id="checkBox" name="active_status" {{ $user->active_status == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-success btn-round btn-md hover-btn btn-sm">Edit/Update</button>
                                        </div>
                                    </div>
